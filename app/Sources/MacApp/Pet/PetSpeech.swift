...
struct PetSpeechLines: Codable {
    ...
    static let builtIn = PetSpeechLines(lines: [
        .greeting: ["こんにちは。", "呼びました?", "なんでしょう?", "はい、ここに。"],
        .running: ["デバイスを探しています…", "少々お待ちを。", "いま確認しています。", "もう少しかかります。"],
        .needsInput: ["確認をお願いします。", "どうしますか?", "お返事を待っています。"],
        .ready: ["終わりました。", "新しいデバイスが見えました!", "お待たせしました。"],
        .blocked: ["うまくいきませんでした…", "エラーが出ています。", "もう一度試してみますか?"],
        .idle: ["…。", "ふぅ。", "今日はいい天気ですね。", "退屈です。", "静かですね。"],
        .dragging: ["わっ。", "どこへ行くんです?", "揺れます…"],
        .wake: ["おはようございます。", "ここにいますよ。", "戻りました。"],
    ])
