...
| --- | --- | --- | --- | --- |
| 〜1.5 分 | — | — | 正常 | 何もしない |
| **1 分〜** | **見ていない状態が 15 秒継続** | 応答なし / 置かれたまま | **サボり確定** | **Mac のカメラで顔を撮る** → 音楽を止めて説教 → Discord |
| **1 分〜** | **見ていない状態が 15 秒継続** | 操作中 | **サボり確定** | **iPhone のスクショを撮る** → 音楽を止めて説教 → Discord |
...
| 音楽を止める | AppleScript / メディアキーが通るか（権限が無ければその旨） |
